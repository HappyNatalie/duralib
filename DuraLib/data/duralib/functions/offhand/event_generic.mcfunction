...
execute store result score %amount% duralib run data get entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".duralib.damage_types.generic.amount
