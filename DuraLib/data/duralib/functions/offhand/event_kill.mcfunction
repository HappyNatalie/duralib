...
advancement revoke @s only duralib:offhand/kill
#gets item data
function duralib:offhand/getdata
execute store result score %amount% duralib run data get entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".duralib.damage_types.killed_entity.amount
