...
data modify storage duralib:temp event_queue set from entity @s item.components."minecraft:custom_data".duralib.damage_events.enemy_attacked_player.damage_events
