...
data modify storage duralib:temp event_queue set from entity @s item.components."minecraft:custom_data".duralib.damage_events.player_killed_enemy.damage_events
