...
advancement revoke @s only duralib:mainhand/attack
#gets item data
function duralib:mainhand/getdata
execute store result score %amount% duralib run data get entity @s SelectedItem.components."minecraft:custom_data".duralib.damage_types.player_attack_enemy.amount
