...
data modify storage duralib:temp event_queue set from entity @s item.components."minecraft:custom_data".duralib.damage_events.custom.damage_events
#modifies data scores according to list
execute if data storage duralib:temp event_queue[0] run function duralib:generic/process_custom_event/execute_list
