...
advancement revoke @s only duralib:mainhand/getattack
#gets item data
function duralib:mainhand/getdata
execute store result score %amount% duralib run data get entity @s SelectedItem.components."minecraft:custom_data".duralib.damage_types.enemy_attack_player.amount
